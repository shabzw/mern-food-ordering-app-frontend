...
export const useGetMyRestaurantOrders = () => {
    ...
    const {data: orders, isLoading} = useQuery("fetchRestaurantOrders", getMyRestaurantOrdersRequest, )
...
export const useUpdateMyRestaurantOrder = () => {
    ...
    const {mutateAsync: updateRestaurantStatus, isLoading, isError, reset, isSuccess} = useMutation(updateMyRestaurantOrder)
